...
public class ModifyOrSell extends AppCompatActivity {
    ...
    EditText txtView,txtView1,txtView2,txtView3,txtView5,txtView6;
    TextView txtView4,txtView7,txtView8;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        message8 = bundle.getString("payoff");
         ...
         txtView = (EditText) findViewById(R.id.tv_symbol_m);
         txtView1 = (EditText)findViewById(R.id.tv_noofstocks_m);
         ...
         txtView7 = (TextView) findViewById(R.id.tv_sellprice_m);
